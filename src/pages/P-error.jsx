...
function ErrorPage(props) {
    return (
        <div style={{width:'100%',height:'100vh',display:'flex',alignItems:'center',justifyContent:'center', textAlign: 'center' , flexDirection:'column'}}>
            <svg 
            ...
            >
                ...
                />
                <path 
                    d="M14.88 9.2998C14.1 8.2198 12.924 7.7998 11.964 7.7998C10.164 7.82381 8.52002 9.3108 8.52002 11.2438C8.52002 12.3095 8.82002 13.0798 9.66002 13.9198" 
                    stroke="currentColor" 
                    strokeWidth="1.5" 
                    strokeLinecap="round" 
                />
